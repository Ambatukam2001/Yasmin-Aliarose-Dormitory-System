<footer style="background:#0f172a;color:#f8fafc;padding:4rem 0 2rem;font-family:'Inter',system-ui,sans-serif;">
    <div style="width:100%;max-width:1200px;margin:0 auto;padding:0 1.5rem;text-align:center;">
        <h3 style="font-family:'Outfit',sans-serif;font-size:1.5rem;font-weight:700;color:#34d399;margin-bottom:0.75rem;"><?php echo $site_name; ?></h3>
