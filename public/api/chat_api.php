...
if ($action === 'send_message') {
    ...
    if ($stmt->execute([$chat_id, $sender_type, $message, $file_url, $is_voice])) {
        ...
        $stmt_update->execute([$last_msg, $chat_id]);
