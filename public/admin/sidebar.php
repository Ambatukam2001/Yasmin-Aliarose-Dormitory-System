<aside class="sidebar admin-sidebar" aria-label="Admin navigation">
    ...
    <nav>
        <div class="sidebar-nav-scroll">
            ...
            <a href="request_outs.php" class="nav-item <?php echo $route === 'request_outs' ? 'active' : ''; ?>">
                <i class="fas fa-sign-out-alt"></i> <span>Request-Outs</span>
            </a>
        ...
        <div class="sidebar-footer nav-logout">
